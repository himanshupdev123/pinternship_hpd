...
**What is Git?**: Git tracks changes in code. GitHub hosts Git repositories online for collaboration.

**Installation & Setup**:
1. Download Git from official website and install
2. Verify installation: `git --version`
3. Create GitHub account at [github.com](https://github.com){:target="_blank"}
...
**How to Contribute and Send Pull Requests**:
1. **Fork** the [Pinternship repository](https://github.com/sudarshansudarshan/pinternship){:target="_blank"}
...
```
4. **Make changes** and save locally
5. **Commit and push**:
```bash
git add .
...
```
6. **Create Pull Request**: Go to your forked repository → "Compare & pull request" → Add title → "Create Pull Request"

**VLED team will review, comment, and merge your PR requests.**
